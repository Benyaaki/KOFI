...
const copy = {
  en: {
    ...
    hero:{eyebrow:'Mobile coffee shop · Miami, FL',titleA:'COFFEE WITH',titleB:'MAIN CHARACTER',titleC:'ENERGY.',body:'Colorful sips, Colombian roots, and a little bit of sparkle. Find our pink truck popping up around Miami.',find:'Find the truck',menu:'Explore the menu',ticker:'MATCHA ✦ COFFEE ♥ MIAMI ✦ GOOD VIBES'},
    ...
    booking:'PARTIES · WEDDINGS · BRAND EVENTS · JUST BECAUSE',party:<>Bring KOFI<br/>to your <em>party.</em></>,cute:'Let’s make it cute',mobile:<>Mobile coffee shop<br/>Miami, Florida</>,events:'Events & contact',slogan:<>COLOMBIAN COFFEE <i>♥</i> MIAMI ENERGY</>,top:'BACK TO TOP'
  },
  es: {
    ...
    hero:{eyebrow:'Cafetería móvil · Miami, FL',titleA:'CAFÉ CON',titleB:'ENERGÍA DE',titleC:'PROTAGONISTA.',body:'Bebidas llenas de color, raíces colombianas y un poquito de brillo. Encuentra nuestro truck rosado recorriendo Miami.',find:'Encuentra el truck',menu:'Explora el menú',ticker:'MATCHA ✦ CAFÉ ♥ MIAMI ✦ BUENA ENERGÍA'},
    ...
    booking:'FIESTAS · BODAS · EVENTOS DE MARCA · PORQUE SÍ',party:<>Lleva KOFI<br/>a tu <em>fiesta.</em></>,cute:'Hagámoslo especial',mobile:<>Cafetería móvil<br/>Miami, Florida</>,events:'Eventos y contacto',slogan:<>CAFÉ COLOMBIANO <i>♥</i> ENERGÍA DE MIAMI</>,top:'VOLVER ARRIBA'
  }
};
  ...
  return (
    <main>
      ...
      <section className="stopsSection" id="stops">
        <div className="stopsIntro"><p className="sectionNo">03 — {t.where}</p><h2>{t.catch}</h2><p>{t.whereBody}</p><a className="button light" href="https://www.instagram.com/kofi_miam" target="_blank" rel="noreferrer">{t.follow} <span>↗</span></a></div>
