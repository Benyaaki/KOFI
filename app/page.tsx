...
export default function Home() {
  return (
    <main>
      ...
      <footer><div className="footerTop"><a className="brand footerBrand" href="#top">KOFI<span>®</span></a><p>Mobile coffee shop<br />Miami, Florida</p><div><a href="https://www.instagram.com/kofi_miam/" target="_blank" rel="noreferrer">Instagram ↗</a><a href="https://www.tiktok.com/@kofi_miam" target="_blank" rel="noreferrer">TikTok ↗</a><a href="mailto:areconyg@gmail.com">Email us ↗</a></div></div><div className="footerBottom"><span>© 2026 KOFI MIAMI</span><a href="https://calfers.com" target="_blank" rel="noreferrer">HECHO POR CALFERS ↗</a><a href="#top">BACK TO TOP ↑</a></div></footer>
    </main>
  );
}
